...
export const whiteboards = pgTable('whiteboards', {
  ...
  projectIdIdx: index('idx_whiteboards_project_id').on(table.projectId),
}));
...
export const whiteboardElements = pgTable('whiteboard_elements', {
  ...
  boardIdIdx: index('idx_whiteboard_elements_board_id').on(table.boardId),
  zIndexIdx: index('idx_whiteboard_elements_z_index').on(table.zIndex),
}));
